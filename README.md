...
> [!TIP]
> **Tester wanted:** nfdump 1.8.x is nearing release. See the [Beta 1.8.x](https://github.com/phaag/nfdump/tree/1.8.x) branch. Give the new branch a try and let me know whether it works for you.
